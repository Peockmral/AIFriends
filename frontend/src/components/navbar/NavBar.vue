...
<template>
  <div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content">
      <nav class="navbar w-full bg-base-100 shadow-md">
        ...
        <div class="navbar-end">
          ...
          <RouterLink v-if="user.hasPulledUserInfo && !user.isLogin()" :to="{name: 'user-account-login-index'}" active-class="btn-active" class="btn btn-ghost text-lg mr-6">
            登录
          </RouterLink>
    ...
    <div class="drawer-side is-drawer-close:overflow-visible">
      ...
      <div class="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-16 is-drawer-open:w-60">
        <ul class="menu w-full grow">
          ...
          <li>
            <RouterLink :to="{name: 'friends-index'}" active-class="menu-focus" class="is-drawer-close:tooltip is-drawer-close:tooltip-right py-3" data-tip="好友">
              <FriendIcon/>
